...
function buildConfig(args) {
    ...
    program
      ...
      .option('--results-out <file>', 'File name for results json output (default: results-file.json)', 'results-file.json')
      .option('--specs-out <file>', 'File name for spec json output (default: spec-file.json)', 'spec-file.json')
